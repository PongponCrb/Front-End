...
import Contact from './Hiring/Contact'
import Agreement from './Application/Agreement'
import Chat_List from './Chat/Chat_List'
import Bookmark_Employer from '../BottomTab_Employer/Bookmark_Employer'
  ...
  const MyDrawerNavigator = createDrawerNavigator({
    ...
    Chat_List: {
      ...
      navigationOptions: {
        ...
        drawerLabel: 'Chat',
        drawerIcon:() => (
          <FontAwesome name='comment' type='antdesign' color='white' size={24}/>
        )
      }
    },
    Bookmark_Employer: {
