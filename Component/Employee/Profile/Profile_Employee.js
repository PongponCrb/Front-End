...
export default class Profile_Employee extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            interest :[{num:1, list:'ช่างยนต์/ช่างกลโรงงาน'},
                       {num:2, list:'ช่างซ่อมบำรุง'},
                       {num:3, list:'ช่างอิเล็กทรอนิกส'},
                       {num:4, list:'ช่างเทคนิค'}],
        ...
        return(
            <View style={{flex:1, flexDirection:'column', marginTop:32}}>
                ...
                <Text style={{fontSize:26, margin:5}}> {this.state.firstName}  {this.state.lastName} </Text>
                    <Text style={{fontSize:18 , margin:5}}> {this.state.dataUser.email} </Text>
                    <Text style={{fontSize:14 , margin:5}}> {this.state.dataUser.tel} </Text>
                </View>
